...
$logoUrl = $branding['logo_premium'] ?? ($branding['logo_light'] ?? base_url('/imgs/logomarca.svg'));
$coverImageUrl = $assets['cover_image_url'] ?? '';
$rebecaImageUrl = $assets['rebeca_image_url'] ?? '';
...
$contactPhone = '(27) 99603-4719';

$investmentPageLogoUrl = base_url('/assets/uploads/branding/logo-light-20260322-141234-af832fe0.png');
$whoPageLogoUrl = base_url('/assets/uploads/branding/logo-dark-20260322-144401-c9b4be20.png');
$contactPageLogoUrl = base_url('/assets/uploads/branding/logo-dark-20260322-144401-c9b4be20.png');
